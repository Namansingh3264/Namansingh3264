...
- 💼 Former **Lead, DevC** — Development Club, IIIT Bhagalpur
- 🌱 Currently exploring **Agentic AI**
- 🏆 500+ DSA problems solved | 50+ rated contests | CodeChef 3★ | Codeforces max 1239
- ⚡ Fun fact: I love turning half-baked ideas into shipped products
...
|---|---|---|---|
| **Parley** | Peer-to-peer video/audio/chat calling directly in the browser — no server relay | Next.js · TypeScript · WebRTC | [GitHub](https://github.com/Namansingh3264/Parley) · [Live](https://parley-ol10.onrender.com) |
| **PacketLens** | High-performance, multi-threaded Deep Packet Inspection (DPI) engine for high-speed network traffic | C++ · C++17 | [GitHub](https://github.com/Namansingh3264/PacketLens) · [Live Dashboard](https://dpi-dashboard-pbsa.onrender.com) |
| **NexusEditor** | Real-time collaborative rich-text editor with live document sync, secure sharing & role-based permissions | Next.js · Socket.io · Prisma | [GitHub](https://github.com/Namansingh3264/NexusEditor) |
| **MEDILATCH** | Doctor-appointment booking platform — patient app, admin panel & REST API across 3 repos | React · Vite · Node.js · Express · MongoDB | [Frontend](https://github.com/Namansingh3264/MEDILATCH-frontend) · [Backend](https://github.com/Namansingh3264/MEDILATCH-backend) · [Admin](https://github.com/Namansingh3264/MEDILATCH-adminfrontend1) |
| **MedicalChatbot** | AI-assisted medical chatbot | TypeScript | [GitHub](https://github.com/Namansingh3264/MedicalChatbot) |
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=Namansingh3264&color=blueviolet&style=flat" alt="profile views"/>
</p>
